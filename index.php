...
<head>
    ...
    <title>Play  Pal </title>
    <link rel="shortcut icon" type="image/png" href="assets/img/barlogo.png">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
                ...
                <!-- hs ere we have unlinked the page 
             using // initial-->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Play Pal </h1>
                            <p class="intro-text">
                            Unlock endless fun with our toy rental system!
                            </p>
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Available Toys </h3>
<br>
 
<section class="menu-content">
            <?php   
            $sql1 = "SELECT * FROM toys WHERE toy_availability='yes'";
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    $ac_price_per_day = $row1["owner_name"];
                    $non_ac_price = $row1["owner_contact"];
                    $non_ac_price_per_day = $row1["owner_location"];
                    $car_img = $row1["toy_img"];
            ...
            <h6> Fare: <?php echo ("Rs. " . $ac_price . "\n & Owned By " . $ac_price_per_day . ""); ?></h6>
