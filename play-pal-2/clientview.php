...
<?php $login_client = $_SESSION['login_client']; 
    ...
    $sql1 = "SELECT * FROM rentedtoys rc, clienttoys cc, customers c, toys WHERE cc.client_username = '$login_client' AND cc.toy_id = rc.toy_id AND rc.return_status = 'R' AND c.customer_username = rc.customer_username AND cc.toy_id = toys.toy_id";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1>No booked Toys</h1>
        <p> Rent some Toys now <?php echo $conn->error; ?> </p>
      </div>
    </div>
