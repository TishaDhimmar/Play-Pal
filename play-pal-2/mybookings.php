...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM rentedtoys rc, toys c WHERE rc.customer_username='$login_customer' AND c.toy_id=rc.toy_id AND rc.return_status='R'";
...
<th width="10%">Fare</th>
<th width="15%">Distance (Drop/Pick in kms)</th>
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any toys till now!</h1>
        <p class="text-center"> Please rent toys in order to view your data here. </p>
      </div>
    </div>
