...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT c.toy_name, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type, rc.id FROM rentedtoys rc, toys c
    WHERE rc.customer_username='$login_customer' AND c.toy_id=rc.toy_id AND rc.return_status='NR'";
...
<div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Return your toys here</h1>
...
?></td>
<td><a href="returntoy.php?id=<?php echo $row["id"];?>"> Return </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">No Toys to return.</h1>
        <p class="text-center"> Hope you enjoyed our service </p>
      </div>
    </div>
