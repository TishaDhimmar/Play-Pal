    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Control Panel <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="returntoy.php">Return Now</a></li>
...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.toy_name, c.toy_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type, d.dp_name, d.dp_phone
 FROM rentedtoys rc, toys c, deliverypartner d
 WHERE id = '$id' AND c.toy_id=rc.toy_id AND d.dp_id = rc.dp_id";
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Toy:&nbsp;  <?php global $car_name;echo($car_name);?></h5>

           <h5> Unique Number:&nbsp;  <?php global $car_nameplate;echo($car_nameplate);?></h5>

           <h5> Rent date:&nbsp;  <?php global $rent_start_date;echo($rent_start_date);?></h5>

           <h5> End Date:&nbsp;  <?php global $rent_end_date;echo($rent_end_date);?></h5>

           <h5> Fare:&nbsp;  Rs. <?php global $charge_type;global $fare;
            if($charge_type=="days"){
                echo ($fare . "/day");
            } else {
                echo ($fare . "/day");
           ...
           <h5> Delivery Partner Name:&nbsp;  <?php global $driver_name;echo($driver_name);?></h5>

           <h5> Delivery Partner Contact:&nbsp;  <?php global $driver_phone;echo($driver_phone);?></h5>
          ...
          <?php }  else { ?>
            <h5> Number of Day(s):&nbsp;  <?php global $no_of_days; echo($no_of_days);?></h5> 
